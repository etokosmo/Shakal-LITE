...
<h3>В проекте присутвует функция random.sample с аргументом counts, который доступен только с <b>Python v3.9. Просьба перед началом установить данную версию или более новую.</b>
